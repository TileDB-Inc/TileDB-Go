...
//go:generate go run ./tools/sizegen --out generated_sizes.go --pkg tiledb --export
...
func (q *Query) SetBuffer(attributeOrDimension string, buffer interface{}) (*uint64,
	...
	case reflect.Int:
		// Set buffersize
		bufferSize = bufferSize * IntBytes
		// Create buffer void*
	...
	case reflect.Int8:
		// Set buffersize
		bufferSize = bufferSize * Int8Bytes
		// Create buffer void*
	...
	case reflect.Int16:
		// Set buffersize
		bufferSize = bufferSize * Int16Bytes
		// Create buffer void*
	...
	case reflect.Int32:
		// Set buffersize
		bufferSize = bufferSize * Int32Bytes
		// Create buffer void*
	...
	case reflect.Int64:
		// Set buffersize
		bufferSize = bufferSize * Int64Bytes
		// Create buffer void*
	...
	case reflect.Uint:
		// Set buffersize
		bufferSize = bufferSize * UintBytes
		// Create buffer void*
	...
	case reflect.Uint8:
		// Set buffersize
		bufferSize = bufferSize * Uint8Bytes
		// Create buffer void*
	...
	case reflect.Uint16:
		// Set buffersize
		bufferSize = bufferSize * Uint16Bytes
		// Create buffer void*
	...
	case reflect.Uint32:
		// Set buffersize
		bufferSize = bufferSize * Uint32Bytes
		// Create buffer void*
	...
	case reflect.Uint64:
		// Set buffersize
		bufferSize = bufferSize * Uint64Bytes
		// Create buffer void*
	...
	case reflect.Float32:
		// Set buffersize
		bufferSize = bufferSize * Float32Bytes
		// Create buffer void*
	...
	case reflect.Float64:
		// Set buffersize
		bufferSize = bufferSize * Float64Bytes
		// Create buffer void*
...
func (q *Query) SetBufferNullable(attributeOrDimension string, buffer interface{}, bufferValidity []uint8) (*uint64, *uint64, error) {
	...
	bufferValiditySize := uint64(len(bufferValidity)) * Uint8Bytes
...
func (q *Query) SetBufferVar(attributeOrDimension string, offset []uint64, buffer interface{}) (*uint64, *uint64, error) {
	...
	offsetSize := uint64(len(offset)) * Uint64Bytes
	...
	for attributeOrDimension, v := range q.resultBufferElements {
		...
		if attributeOrDimension == TILEDB_COORDS {
			...
			if v[0] != nil {
				...
				offsetElements = (*v[0]) / Uint64Bytes
			}

			validityElements := uint64(0)
			if v[2] != nil {
				// The attribute is nullable
				validityElements = (*v[2]) / Uint8Bytes
			}
